...
class MultichannelPromotionModel(BaseModel):
    ...
    &nbsp;The this object uses to set and get the duration of a promotion., defaults to None
    ...
    &nbsp;
    &nbsp;This fields populates the "Presentation" section in the admin UI., defaults to None
    :type presentation: PromotionBasicPresentationModel, optional
    :param redemption_channels: Redemption channels
    &nbsp;Valid channels: POS, ECOM and OTHER, defaults to None
